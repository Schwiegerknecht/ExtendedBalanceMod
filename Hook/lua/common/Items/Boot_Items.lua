...
-- Let proc trigger at anything below 100% of base Movement Speed -- Schwiegerknecht
-- If UberFix is being used, just change the trigger point
if Ability.Item_Boot_070.TriggerPercent then
    Ability.Item_Boot_070.TriggerPercent = 1
else -- Else incorporate the UberFix changes to Ironwalkers' mechanics
    Ability.Item_Boot_070.TriggerPercent = 1
    ...
    --And include the Desperate Boots fix as well
...
-- Change Description to include changed proc
